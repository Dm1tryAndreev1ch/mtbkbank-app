...
```bash
node "/Users/andreevich/Documents/Projects/gm-bank-app/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/andreevich/Documents/Projects/gm-bank-app/.claude/get-shit-done/templates/retrospective.md`.
