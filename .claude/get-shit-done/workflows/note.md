...
- **Global scope**: `/Users/andreevich/Documents/Projects/gm-bank-app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/andreevich/Documents/Projects/gm-bank-app/.claude/notes/`)
...
2. Glob `/Users/andreevich/Documents/Projects/gm-bank-app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/andreevich/Documents/Projects/gm-bank-app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/andreevich/Documents/Projects/gm-bank-app/.claude/notes/` — works in any directory
