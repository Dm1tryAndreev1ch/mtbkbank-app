...
```
Task(
  prompt="Read /Users/andreevich/Documents/Projects/gm-bank-app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/andreevich/Documents/Projects/gm-bank-app/.claude/get-shit-done/templates/VALIDATION.md`
