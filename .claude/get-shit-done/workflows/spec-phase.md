...
```bash
INIT=$(node "/Users/andreevich/Documents/Projects/gm-bank-app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/andreevich/Documents/Projects/gm-bank-app/.claude/get-shit-done/templates/spec.md.
