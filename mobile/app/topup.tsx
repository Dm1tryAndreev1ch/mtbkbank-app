  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Пополнить карту</Text>
        <View style={{ width: 40 }} />
      </View>
      <View style={styles.content}>
        <MaterialIcons name="add-card" size={80} color={Colors.primary} />
        <Text style={styles.text}>Выберите способ пополнения: с другой карты, через ЕРИП или наличными в банкомате.</Text>
      </View>
    </SafeAreaView>
  );
}
