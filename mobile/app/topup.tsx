          ...
          <ScrollView contentContainerStyle={s.form} keyboardShouldPersistTaps="handled">
            {selected === 'card' && (
              <Animated.View entering={FadeInDown}>
                ...
                <TextInput style={s.input} value={cardNum} onChangeText={v => setCardNum(formatCard(v))} placeholder="0000 0000 0000 0000" placeholderTextColor={colors.outlineVariant} keyboardType="numeric" maxLength={19} />
              </Animated.View>
            )}
            {selected === 'erip' && (
              <Animated.View entering={FadeInDown}>
                <Text style={s.fieldLbl}>Код услуги ЕРИП</Text>
                <TextInput style={s.input} placeholder="Например: 381012" placeholderTextColor={colors.outlineVariant} keyboardType="numeric" />
              </Animated.View>
            )}
