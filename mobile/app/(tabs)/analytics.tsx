...
const getStyles = (C: any) => StyleSheet.create({
  ...
  chartCard: { marginHorizontal: Spacing.base, backgroundColor: C.surfaceContainerLowest, borderRadius: BorderRadius.lg, paddingVertical: Spacing.base, paddingHorizontal: Spacing.base, borderWidth: 1, borderColor: C.transparentBorder, ...Shadows.sm },
  ...
  legendItem: { flexBasis: '47%', flexGrow: 0, flexShrink: 0, backgroundColor: C.surfaceContainerHigh, padding: Spacing.sm, borderRadius: BorderRadius.base, gap: 2, minHeight: 72 },
  ...
  gearBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 6, borderRadius: BorderRadius.sm, backgroundColor: `${C.primary}14` },
