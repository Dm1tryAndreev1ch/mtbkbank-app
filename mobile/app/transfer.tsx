          ...
          <ScrollView contentContainerStyle={s.form} keyboardShouldPersistTaps="handled">
            {selected === 'card' && (
              <Animated.View entering={FadeInDown}>
                ...
                <TextInput style={s.input} value={recipient} onChangeText={v => setRecipient(formatCard(v))} placeholder="0000 0000 0000 0000" placeholderTextColor={colors.outlineVariant} keyboardType="numeric" maxLength={19} />
              </Animated.View>
            )}
            {selected === 'phone' && (
              <Animated.View entering={FadeInDown}>
                <Text style={s.fieldLbl}>Номер телефона</Text>
                <TextInput style={s.input} value={recipient} onChangeText={v => setRecipient(formatPhone(v))} placeholder="+375 XX XXX-XX-XX" placeholderTextColor={colors.outlineVariant} keyboardType="phone-pad" maxLength={17} />
              </Animated.View>
            )}
            {selected === 'own' && (
              <Animated.View entering={FadeInDown}>
